...
{
    /// <inheritdoc />
    public partial class AddMealPlanRecipes : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrepTime = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    CookTime = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    Ingredients = table.Column<string>(type: "TEXT", nullable: false),
                    Instructions = table.Column<string>(type: "TEXT", nullable: false),
                    ShareToken = table.Column<string>(type: "TEXT", maxLength: 36, nullable: false)
                },
                constraints: table =>
                {
